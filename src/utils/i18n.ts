...
export const translations = {
  en: {
    ...
    kdsDateFilterToday: "Today",
    kdsDateFilterYesterday: "Yesterday",
    kdsDateFilterLast7Days: "Past 7 Days",
    kdsDateFilterAllTime: "All Time",
    kdsDateFilterCustom: "Pick Date",
    kdsDateFilterTitle: "Date Filter:",
    kdsRefreshData: "Refresh Data",
    kdsLastUpdated: "Updated",
    kdsShowingDataFor: "Displaying:",
    kdsOrdersFound: "orders found",
  ...
  th: {
    ...
    kdsDateFilterToday: "วันนี้",
    kdsDateFilterYesterday: "เมื่อวาน",
    kdsDateFilterLast7Days: "7 วันล่าสุด",
    kdsDateFilterAllTime: "ประวัติทั้งหมด",
    kdsDateFilterCustom: "เลือกวันที่",
    kdsDateFilterTitle: "ช่วงเวลาข้อมูล:",
    kdsRefreshData: "รีเฟรชข้อมูล",
    kdsLastUpdated: "อัปเดต",
    kdsShowingDataFor: "กำลังแสดง:",
    kdsOrdersFound: "ออเดอร์",
