...
export function t(key: keyof typeof translations['th'], lang: Language): string {
  const dict = translations[lang] || translations['th'];
  return (dict[key] as string) || (translations['th'][key] as string) || (key as string);
}
